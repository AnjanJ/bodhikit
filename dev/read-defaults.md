...
| `/reflect` | `state.json`, `progress.md`, today's `reviewHistory[]` entries (same-day guard), `bodhi-state revision-brief` + `.bodhi/resources.md` for the revision sheet | rarely |
